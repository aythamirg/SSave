...
public class EntradasCentroAlumnadoActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entradas_centro_alumnado);
        ...
        mSearchView = (SearchView) findViewById(R.id.search_viewEntradasCentroAlumnado);

        mListView = (ListView) findViewById(R.id.list_viewEntradasCentroAlumnado);
    ...
    public void alertOneButton(final String dniAlumno_) {
        ...
        new AlertDialog.Builder(EntradasCentroAlumnadoActivity.this)
                .setTitle(dniAlumno_)
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                Intent intent = new Intent(EntradasCentroAlumnadoActivity.this, VerificarTutorEntradaActivity.class);

                intent.putExtra("datoDniAlumnoEntradas",dniAlumno_);

                intent.putExtra("datoDniProfesorEntradas",dniProfesor_);
    ...
    public void listadoSalidasComprobar(){
        ...
        try{
            ...
            stmt = connection.createStatement();
            String sql = "SELECT dnialumno,fecha FROM entradas;";
            ResultSet rs = stmt.executeQuery(sql);
